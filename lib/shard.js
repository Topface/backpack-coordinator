(function(module) {
    ...
    Shard.prototype.acceptWriteRequest = function(req, cb) {
        ...
        coordinator.incrementShardDataSize(self.id, size, coordinator.emit.bind(coordinator, "error"));
    ...
    Shard.prototype.writeToNodeFromFile = function(id, path, size, file, callback) {
